  ...
  return (
    <footer className="relative bg-[#0d0d0d] pt-32 pb-10 sm:pb-12 mt-24">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-0 transform -translate-y-[99%]">
        ...
        >
          <path 
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.08,130.83,119.7,194.2,107.5,237.49,99.23,279.28,78.5,321.39,56.44Z" 
